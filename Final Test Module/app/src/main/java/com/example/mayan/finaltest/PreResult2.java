 ...
 */
public class PreResult2 extends Activity {
    int ln=0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lView = (ListView) findViewById(R.id.li1);
    ...
    void add()
    {
        adapter = new MyCustomAdapter2(list, this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                try
                {
                    ...
                    URL url = new URL("http://10.0.2.2/upload/testattempted.php");
