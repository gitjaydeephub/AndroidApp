 ...
 */
public class Resultl extends Activity {
    int ln=0;
    TextView ra;
...
name = i.getStringExtra("uname");
        ...
        setContentView(R.layout.activity_resultl);

         ra= (TextView) findViewById(R.id.na);
ra.setText(""+name+"vjhgkjh");
        try {
    ...
    void add()
    {
        adapter = new MyCustomAdapter1(list, this);

       // handle listview and assign adapter
         ListView lView = (ListView)findViewById(R.id.li1);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                try
                {
                    ...
                    URL url = new URL("http://10.0.2.2t/upload/testattempted.php");
